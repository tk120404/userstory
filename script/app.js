(function() {
    ...
    app.factory('Roles', function() {
        var Roles = {};
        Roles.roles = ['user', 'developer', 'end-user', 'admin', 'teacher', 'engineer', 'artist', 'PO', 'manager', 'doctor', 'vendor', 'scientist', 'contractor', 'client', 'customer', 'geek', 'hacker', 'CEO', 'cashier', 'journalist'];
        return Roles;
    });
